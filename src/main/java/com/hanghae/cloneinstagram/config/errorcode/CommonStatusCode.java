...
public enum CommonStatusCode implements StatusCode {
     ...
     POST_LIKE(true, "게시글 좋아요", HttpStatus.OK.value()),
     POST_LIKE_CANCEL(true, "게시글 좋아요취소", HttpStatus.OK.value()),
     COMMENT_LIKE(true, "댓글 좋아요", HttpStatus.OK.value()),
     COMMENT_LIKE_CANCEL(true, "댓글 좋아요취소", HttpStatus.OK.value()),
     ...
     UNFOLLOW_USER(true, "팔로우 취소 성공", HttpStatus.OK.value()),
